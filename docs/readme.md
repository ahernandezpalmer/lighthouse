...
You'll likely want to use the CLI flags `--no-screenEmulation --throttling.cpuSlowdownMultiplier=1` to disable any additional emulation.
...
$ lighthouse --port=9222 --no-screenEmulation --throttling.cpuSlowdownMultiplier=1 https://example.com
```
